...
function! <SID>DoxygenCommentFunc()
  ...
  if l:doc.params == []
    exec "normal! o".s:interCommentTag.g:DoxygenToolkit_paramTag_pre."None".g:DoxygenToolkit_paramTag_post
  endif
  ...
  if( l:doc.returns == "yes" )
    ...
    exec "normal! o".s:interCommentTag.g:DoxygenToolkit_returnTag."None"
  endif
